...
export const getTodaySpending = (expenses) => {
  ...
  return expenses
    ...
    .reduce((total, expense) => total + convertToUSD(expense.amount, expense.currency), 0);
};
...
export const groupExpensesByDay = (expenses) => {
  const grouped = expenses.reduce((acc, expense) => {
    ...
    acc[date].amount += convertToUSD(expense.amount, expense.currency);
    return acc;
  }, {});
...
export const groupExpensesByWeek = (expenses) => {
  const grouped = expenses.reduce((acc, expense) => {
    ...
    acc[week].amount += convertToUSD(expense.amount, expense.currency);
    return acc;
  }, {});
...
export const groupExpensesByMonth = (expenses) => {
  const grouped = expenses.reduce((acc, expense) => {
    ...
    acc[month].amount += convertToUSD(expense.amount, expense.currency);
    return acc;
  }, {});
...
export const groupExpensesByYear = (expenses) => {
  const grouped = expenses.reduce((acc, expense) => {
    ...
    acc[year].amount += convertToUSD(expense.amount, expense.currency);
    return acc;
  }, {});
...
export const groupExpensesByCategory = (expenses) => {
  const grouped = expenses.reduce((acc, expense) => {
    ...
    acc[category].amount += convertToUSD(expense.amount, expense.currency);
    return acc;
  }, {});
